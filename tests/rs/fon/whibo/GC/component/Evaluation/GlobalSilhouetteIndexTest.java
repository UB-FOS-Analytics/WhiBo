 ...
 */
public class GlobalSilhouetteIndexTest {
	private GCTestUtil testUtil = new GCTestUtil();
	private GlobalSilhouetteIndex globalSilhouetteIndex;
	...
	public void setUp() throws Exception {
		...
		this.globalSilhouetteIndex = new GlobalSilhouetteIndex(
				subproblemParameters);
	}

	@Test
	public void testEvaluate() throws Exception {
		double result = this.globalSilhouetteIndex.Evaluate(
				this.distanceMeasure, this.whiBoCentroidClusterModel,
				this.exampleSet);
		assertEquals(-1.7499189363681005, result, 0d);
	}
}
