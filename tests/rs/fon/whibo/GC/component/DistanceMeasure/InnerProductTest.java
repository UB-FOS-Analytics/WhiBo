...
public class InnerProductTest {
	...
	public void setUp() throws Exception {
		this.innerProduct = new InnerProduct(
				new LinkedList<SubproblemParameter>());
	}

	@Test
	public void testCalculateDistance() throws Exception {
		double distance = innerProduct.calculateDistance(new double[] { 0, 3,
				4, 5 }, new double[] { 7, 6, 3, -1 });
		assertEquals(-25.0, distance, 0d);
	}

	@Test
	public void testCalculateSimilarity() throws Exception {
		double similiarity = innerProduct.calculateSimilarity(new double[] { 0,
				3, 4, 5 }, new double[] { 7, 6, 3, -1 });
		assertEquals(25.0, similiarity, 0d);
	}
}
