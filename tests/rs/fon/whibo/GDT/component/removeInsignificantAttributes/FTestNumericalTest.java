 ...
 */
public class FTestNumericalTest {
	private GDTTestUtil testUtil = new GDTTestUtil();

	private FTestNumerical fTestNumerical;
	...
	public void setUp() throws Exception {
		...
		fTestNumerical = new FTestNumerical(subproblemParameters);
	}

	@Test
	public void testRemoveAttributes() throws Exception {

		LinkedList<Attribute> r = fTestNumerical.removeAttributes(
