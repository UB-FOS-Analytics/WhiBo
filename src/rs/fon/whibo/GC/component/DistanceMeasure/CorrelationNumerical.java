...
public class CorrelationNumerical extends AbstractDistanceMeasure {

	/**
	 * Instantiates a Correlation Similarity similarity measure.
	 * 
	 * @param parameters
	 *            the parameters
	 */

	public CorrelationNumerical(List<SubproblemParameter> parameters) {
		super(parameters);
	}
