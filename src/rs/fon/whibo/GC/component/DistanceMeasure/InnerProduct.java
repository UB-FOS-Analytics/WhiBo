...
public class InnerProduct extends AbstractDistanceMeasure {
	/**
	 * Instantiates a new Inner Product numerical similarity measure.
	 * 
	 * @param parameters
	 *            the parameters
	 */
	public InnerProduct(List<SubproblemParameter> parameters) {
		super(parameters);
	}
