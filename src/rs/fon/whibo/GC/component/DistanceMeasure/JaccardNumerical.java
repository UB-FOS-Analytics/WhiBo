...
public class JaccardNumerical extends AbstractDistanceMeasure {

	/**
	 * Instantiates a Jaccard distance measure.
	 * 
	 * @param parameters
	 *            the parameters
	 */

	public JaccardNumerical(List<SubproblemParameter> parameters) {
		super(parameters);
	}
