...
/**
 * This subproblem defines GUI properties for partitioning clustering
 * initialization components
 * 
 * @author Milan Vukicevic
 */
public class Initialization implements Subproblem {
	...
	/** The description. */
	private String description = "Initializes cluster representatives";
	...
	private String[] availableImplementationClassNames = ReflectionTools
			.getComponentClassNamesForSubproblem(rs.fon.whibo.GC.component.Initialization.Initialization.class);

	/*
	 * = { Random.class.getName(), KMeansPlusPlus.class.getName(),
	 * GMeans.class.getName() };
	 */
