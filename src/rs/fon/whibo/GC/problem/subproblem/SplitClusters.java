...
public class SplitClusters implements Subproblem {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -4477328725691183017L;

	/** The name. */
	private String name = "Split Clusters";

	/** The description. */
	private String description = "Spliting of clusters after creation";
	...
	private String[] availableImplementationClassNames = ReflectionTools
			.getComponentClassNamesForSubproblem(rs.fon.whibo.GC.component.SplitClusters.SplitClusters.class);
