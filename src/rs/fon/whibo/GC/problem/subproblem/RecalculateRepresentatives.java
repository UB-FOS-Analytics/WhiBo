...
public class RecalculateRepresentatives implements Subproblem {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1608912330876289331L;

	/** The name. */
	private String name = "Recalculate representatives";;

	/** The description. */
	private String description = "Recalculate representatives";
	...
	private String[] availableImplementationClassNames = ReflectionTools
			.getComponentClassNamesForSubproblem(rs.fon.whibo.GC.component.RecalculateRepresentatives.RecalculateRepresentatives.class);
