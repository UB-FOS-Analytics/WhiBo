 ...
 */
public class PossibleSplit implements Subproblem {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1608912330876289331L;

	/** The name. */
	private String name = "Create split";;

	/** The description. */
	private String description = "Create split";
	...
	private String[] availableImplementationClassNames = ReflectionTools
			.getComponentClassNamesForSubproblem(rs.fon.whibo.GDT.component.possibleSplits.PossibleSplit.class);
