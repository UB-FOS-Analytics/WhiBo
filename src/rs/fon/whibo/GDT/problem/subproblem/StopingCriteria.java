...
/**
 * This subproblem defines GUI properties for stop criteria components
 * 
 * @author Nikola Nikolic
 */
public class StopingCriteria implements Subproblem {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -1687397638793900282L;

	/** The name. */
	private String name = "Stop criteria";;

	/** The description. */
	private String description = "Stop criteria";
	...
	private String[] availableImplementationClassNames = ReflectionTools
			.getComponentClassNamesForSubproblem(rs.fon.whibo.GDT.component.stoppingCriteria.StoppingCriteria.class);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see rs.fon.whibo.problem.Subproblem#setMultiple(boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see rs.fon.whibo.problem.Subproblem#isMultiple()
	 */
