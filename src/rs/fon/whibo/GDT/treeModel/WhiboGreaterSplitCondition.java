...
/**
 * Implements the Greater than condition used by the TreeModel.
 */
public class WhiboGreaterSplitCondition extends WhiboAbstractSplitCondition {
	...
	/**
	 * Instantiates a new whibo greater split condition.
	 * 
	 * @param attribute
	 *            the attribute
	 * @param value
	 *            the split value
	 */
	public WhiboGreaterSplitCondition(Attribute attribute, double value) {
